...
from .serializers import (
    ProfileSerializer, AvatarSerializer, TagSerializer, IngredientSerializer,
    RecipeWriteSerializer, FollowSerializer, FollowSerializer
)
...
def add_to_favorites(request, pk):
    ...
    serializer = RecipeWriteSerializer(recipe, context={'request': request})
